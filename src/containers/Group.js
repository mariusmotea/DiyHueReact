...
const Group = ({
    ...
    return ( <
        ...
        onChange = {
          (e) => handleToggleChange(e.target.checked)
        }
        /> <
        ...
        className = "slider"
        onChange = {
          (e) => debouncedChangeHandler(parseInt(e.target.value))
        }
        /> <
        /div> <
        /div> <
        ...
        /AnimateSharedLayout> {
          showContainer === "closed" && ( <
            ...
            <
            div className = "expandbtn" > < FaChevronDown onClick = {
            ...
            ( < div className = "row bottom" >
              <
              div className = "btn" > < FaPalette onClick = {
                () => setShowContainer("colorPicker")
              }
              /> <
              /div> <
              div className = "btn" > < FaImages onClick = {
                () => setSceneModal(true)
              }
              /></div >
              <
              div className = "expandbtn" > < FaChevronUp onClick = {
                () => setShowContainer("closed")
              }
              /></div >
              <
              div className = "btn" > < FaLightbulb onClick = {
                () => setShowContainer("lights")
              }
              /></div >
              <
              div className = "btn" > < MdInvertColors onClick = {
